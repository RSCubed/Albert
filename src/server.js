...
var cohereKey = process.env.COHERE_API;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                file = "./temp.webm";
                fileLink = "";
                return [4 /*yield*/, fs.readFileSync(file)];
            case 1:
                fileData = _a.sent();
                return [4 /*yield*/, assemblyUpload.post("/upload", fileData)];
            case 2:
                ...
                return [4 /*yield*/, assembly.post("/transcript", {
                        audio_url: fileLink,
                    })];
            case 3:
                _a.sent();
